...
class Api_Index extends PhalApi_Api
{
    ...
    public function index(){
        $res = $this->httpCurl("https://wxapp.it919.cn/wx/listAllApis.php");
        echo $res;
        die();
    }
     ...
     * @method GET请求
     * @desc 获取赛事直播列表
     * @url http://192.168.1.2:8080/?service=Index.schedule
     ...
     * @method GET请求
     * @desc 获取赛事直播列表
     * @url http://192.168.1.2:8080/?service=Index.live_detail&schid=1470215&liveid=2009587
     ...
     * @method GET请求
     * @desc 比赛直播实时数据
     * @url http://192.168.1.2:8080/?service=Index.live_content&schid=1470215
     */
     ...
     * @method GET请求
     * @desc 球员技术统计信息
     * @url http://192.168.1.2:8080/?service=Index.technical_statistics&schid=1470215
     ...
     * @method GET请求
     * @desc 球员基本信息详情
     * @url http://192.168.1.2:8080/?service=Index.player_detail&playerid=4130
     */
     ...
     * @method GET请求
     * @desc 30只球队联盟排名
     * @url http://192.168.1.2:8080/?service=Index.team_rank
     */
     ...
     * @method GET请求
     * @desc 球队基本信息数据
     * @url http://192.168.1.2:8080/?service=Index.team_info&teamId=15
     */
     ...
     * @method GET请求
     * @desc 球队阵容球员列表
     * @url http://192.168.1.2:8080/?service=Index.Lineup&teamId=15
     */
     ...
     * @method GET请求
     * @desc NBA新闻篮球快讯
     * @url http://192.168.1.2:8080/?service=Index.new_list&page=1
     */
     ...
     * @method GET请求
     * @desc NBA新闻内容详情
     * @url http://192.168.1.2:8080/?service=Index.news_info&docid=D22DCS5S0005877U
     ...
     * @method GET请求
     * @desc 关于个人的JSON数据
     * @url http://192.168.1.2:8080/?service=Index.website
     */
     ...
     * @method GET请求
     * @desc 转发图片代理地址
     * @url http://192.168.1.2:8080/?service=Index.img&imgurl=https://code.it919.cn/img/head.jpg
     */
    public function img()
    {
